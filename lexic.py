...
lex: dict = {
        ...
        'instruct1': 'Ознакомьтесь с <b>требованиями</b> к отправляемым файлам:\n'
                    '\n<u>1. Чистая камера</u>: Убедитесь, что объектив вашей камеры не загрязнен.'
                    '\n<u>2. Фон с элементами интерьера/мебели:</u> Фон в вашем кадре не должен быть однотонным. Важно, чтобы на фоне были видны элементы интерьера или мебели.'
                    '\n<u>3. Положение камеры:</u> Камера должна быть расположена на уровне вашей головы. В кадре должна быть видна полностью ваша голова и верхняя часть туловища.'
                    '\n<u>4. Неподвижная камера:</u> Важно, чтобы камера была абсолютно неподвижной во время съемки. Избегайте дрожания, тряски или перефокусировки камеры.'
                    '\n<u>5. Длительность видео:</u> Каждое видео должно быть от 5 до 10 секунд в длительности.'
                    ...
                    '\n<u>7. Хорошее освещение:</u> Обеспечьте хорошее равномерное освещение без засветов, бликов на лице или затемнений.'
                    ...
                    '\n<u>10. Повороты и наклоны:</u>  Все задания с поворотами и наклонами всегда начинаются с поворота/наклона <b>именно в ЛЕВУЮ сторону</b>'
                    ...
                    '\n<u>12. Видимость рук:</u> При выполнении заданий с действиями рук в кадре должны быть видны полностью ваши кисти и запястья.'
                    '\n<u>13. Вес файлов:</u> Бот не примет файлы тяжелее 50 Мб. В настройках камеры установите Частоту кадров = 30 и разрешение = 1080р, если файлы превышают лимит.',
