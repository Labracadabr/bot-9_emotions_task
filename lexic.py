...
lex: dict = {
        ...
        'start': 'Привет!\n\n'
                 ...
                 'Вам предстоит выполнить 65 заданий. В каждом будет дан пример в виде ссылки на Гугл-диск и краткое описание, что нужно заснять. '
        ...
        'instruct1': 'Спасибо! Теперь ознакомьтесь с <b>требованиями</b> к отправляемым файлам:\n\n'
                     ...
                     '- Фотографии принимаются в любом формате, кроме .heic\n',
        ...
        'instruct2': 'Можете приступать к выполнению. Далее вам будет показано первое задание. Как только отправите '
                     'файл - нажмите команду /next для получения следующего задания. ',
        ...
        'all_approved': 'Поздравляем! Все ваши файлы приняты. Для получения оплаты перешлите данное сообщение тому, кто привел вас к нам.',
