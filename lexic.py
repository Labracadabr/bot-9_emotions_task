...
lex: dict = {
    ...
    ,
        ...
        'instruct1': 'Ознакомьтесь с <b>требованиями</b> к отправляемым файлам:\n'
                    ...
                    '\n<u>2. Фон:</u> Фон в вашем кадре не должен быть однотонным. Важно, чтобы на фоне были видны элементы интерьера или мебели. На фоне <b>не должно быть других людей</b> или фотографий с лицами.'
                    ...
                    '\n<u>4. Неподвижная камера:</u> Важно, чтобы камера была абсолютно неподвижной во время съемки. Избегайте дрожания, тряски или перефокусировки камеры. Не держите телефон в руках, поставьте его на чо-нибудь (на уровне высоты головы)'
                    ...
                    '\n<u>13. Вес файлов:</u> Бот не примет файлы тяжелее 50 Мб. Если видео получаются тяжелыми, в настройках камеры для видео установите Частоту кадров = 30 и разрешение = 1080р.'
                    '\n<u>14. Отражения:</u> На фоне и рядом с вами не должно быть зеркал и иных предметов, где вы можете отражаться.'
                    '\n<u>15. Повторы:</u> – Каждое упражнение выполняется столько раз, сколько показано в примере, ни больше, ни меньше.',
