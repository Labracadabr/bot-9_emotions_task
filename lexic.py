...
lex: dict = {
    'a1': {
        ...
        'instruct1': 'Спасибо! Теперь ознакомьтесь с требованиями.',
        'instruct2': 'Основные требования:\n'
                     '- Убедитесь, что объектив вашей камеры чист\n'
                     '- Лицо должно быть хорошо видно, не обрезано, не\n'
        ...
        'instruct3': 'Можете приступать к выполнению. Далее вам будет показано первое задание. Как только отправите '
                     'файл - вам будет выдано следующее задание. Когда вы выполните все 65 заданий - ваши файлы '
