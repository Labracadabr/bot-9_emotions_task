...
lexicon: dict[str:str] = {
     ...
     'help': '⚙️ For questions about checking tasks and problems with the bot, write @its_dmitrii'
             ...
             '\n/personal - specify data'
             '\n/instruct - view instructions',

     # cancel command
     'cancel': 'Specify the job numbers (two digits) separated by a space for which you want to cancel sending the file. Example message:'
               '\n\n01 02 16',
     ...
     'cancel_wrong_form': 'Invalid format. I expect job numbers separated by spaces.',
     ...
     'start': 'Hello!\n\n'
              ...
              '\n\nYou can click:'
              '\n/next to issue the next task'
              '\n/status to view the status of your tasks'
              '\n/help for support'
              '\n/cancel to cancel sending the file.'
     ...
     'start_again': 'To see a list of commands, press /help',
     ...
     'receive': 'Received file for job {}.\nPress /next for next job',
'all_sent': 'Thank you! You have sent all the necessary files. Please wait for your work to be reviewed.\n'
     ...
     'no_more': 'No jobs available',
     'reject': 'We have checked your work. Unfortunately, some of the files did not pass the scan. Check out our'
     ...
     'all_approved': 'Hurray! Your set has successfully passed the first quality check.\n'
     ...
     'tlk_ok': 'Your data has been saved. Enter the following code in the task interface on Toloka:',
